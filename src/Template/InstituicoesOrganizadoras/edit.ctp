<div class="instituicoesOrganizadoras form">
    <?= $this->Form->create($instituicoesOrganizadora, ['type' => 'file']) ?>
    <fieldset>
        <legend><?= __('Editar Instituição Organizadora'); ?></legend>
        ...
        <div class="input text required">
            ...
            <div class="input-group m-b-1">
                <input id="instituicao-cnpj" type="text" name="instituicao[cnpj]" class="form-control"
                       ...
                       value="<?php echo $instituicoesOrganizadora['instituicao']['cnpj'] != "" ?
                           $instituicoesOrganizadora['instituicao']['cnpj'] : ""; ?>">
...
<script type="application/javascript">
    ...
    $(document).ready(function(){
        //carregar logo
        var id = "<?php echo $instituicoesOrganizadora['instituicao']['id'] ?>";
        var logo = "<?php echo $instituicoesOrganizadora['instituicao']['logo'] ?>";
