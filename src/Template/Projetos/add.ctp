<div class="projetos form">
    ...
    <fieldset>
        <legend><?= __('Adicionar Projeto de Implementação') ?></legend>
        <?php
            echo $this->Form->input('grupo_empresas_id',
                ['options' => $gruposEmpresas, 'empty' => 'Selecione', 'required' => 'required']);
        ?>
...
<script type="application/javascript">
    ...
    $(function () {
        ...
        $("[name='grupo_empresas_id']").change(function(){
            ...
            $.ajax({
                url         :   "<?php echo $this->Url->build(array('action'=>'getprojetobygrupo')); ?>/"+selectedValue,
                dataType    :   'json',
                type        :   'POST',
