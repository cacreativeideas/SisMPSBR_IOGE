<div class="instituicoesAvaliadoras form">
    ...
    <fieldset>
        <legend><?= __('Editar Instituição Avaliadora') ?></legend>
        ...
        <div class="input text required">
            ...
            <div class="input-group m-b-1">
                <input id="instituicao-cnpj" type="text" name="instituicao[cnpj]" class="form-control"
                       ...
                       value="<?php echo $instituicoesAvaliadora['instituicao']['cnpj'] != "" ?
                           $instituicoesAvaliadora['instituicao']['cnpj'] : ""; ?>">
...
<script type="application/javascript">
    ...
    $(document).ready(function(){
        //carregar logo
        var id = "<?php echo $instituicoesAvaliadora['instituicao']['id'] ?>";
        var logo = "<?php echo $instituicoesAvaliadora['instituicao']['logo'] ?>";
