...
use App\Model\Entity\InstituicoesOrganizadora;
use Cake\ORM\Query;
...
/**
 * InstituicoesOrganizadoras Model
 *
 * @property \Cake\ORM\Association\BelongsTo $Instituicoes
 */
class InstituicoesOrganizadorasTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('instituicoes_organizadoras');
